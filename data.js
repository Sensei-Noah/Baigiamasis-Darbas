...
// module.exports = {standardBundles};
console.log(
  standardBundles[0].rooms.craftsRoom.bundles.springForageBundle.items.Wild_Horseradish.name.replace(
    " ",
    "_"
  )
);
...
console.log(standardBundles[0].rooms.craftsRoom.bundles);

standardBundles[0].rooms.craftsRoom.bundles;
