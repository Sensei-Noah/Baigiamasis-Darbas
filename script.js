...
const springFBCon = () => {
  ...
  summerFBTab.className = "tab-pane d-flex flex-wrap d-none";
  fallFBTab.className = "tab-pane d-flex flex-wrap d-none";
  winterFBTab.className = "tab-pane d-flex flex-wrap d-none";
  constFBTab.className = "tab-pane d-flex flex-wrap d-none";
  exoticFBTab.className = "tab-pane d-flex flex-wrap d-none";
...
const summerFBCon = () => {
  ...
  springFBTab.className = "tab-pane d-flex flex-wrap d-none";
  fallFBTab.className = "tab-pane d-flex flex-wrap d-none";
  winterFBTab.className = "tab-pane d-flex flex-wrap d-none";
  constFBTab.className = "tab-pane d-flex flex-wrap d-none";
  exoticFBTab.className = "tab-pane d-flex flex-wrap d-none";
...
let incommon_mushroom = JSON.parse(localStorage.getItem('input_common_mushroom'));
...
let inpurple_mushroom = JSON.parse(localStorage.getItem('input_purple_mushroom'));
